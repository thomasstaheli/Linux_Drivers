...
#define KEY_OFFSET	      0x50 // Offset Boutons, les keys commencent à 0xFF200050
...
/**
 * @brief Met à jour l'affichage des segments hexadécimaux en fonction du caractère affiché et du curseur.
 *
 ...
 *
 * @param displayed_char Pointeur vers la chaîne contenant les caractères à afficher.
 * @param cursor Position actuelle du curseur dans la chaîne `displayed_char`.
 *
 * La fonction détermine l'afficheur concerné et applique un masque pour modifier
 * uniquement la partie du registre associée. Si le caractère à afficher est un espace,
 * l'afficheur correspondant est éteint.
 */
...
int main()
{
	...
	// Premier tour de boucle : Premier registre HEX contenant   : HEX0, HEX1, HEX2, HEX3
	// Deuxième tour de boucle : Deuxième registre HEX contenant : HEX4, HEX5
